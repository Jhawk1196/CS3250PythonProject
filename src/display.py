...
class Display:
    ...
    def display(self, args):  # pragma: no cover
        ...
        exit_menu.add_command(label="Save and exit",
                              command=lambda: [self.go.set(False), self.save_values(),
                                               self.time_var.set(0), root.quit()])
        exit_menu.add_command(label="Exit without Saving",
                              command=lambda: [self.go.set(False), self.time_var.set(0), root.quit()])
